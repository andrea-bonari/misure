...
>Quindi l'incertezza di categoria A è esprimibile come: $$u_{A}(x)=s(\overline{x})=\frac{s(x)}{\sqrt{n}}=\sqrt{ \frac{1}{n(n-1)}\sum\limits_{k=1}^{n}(x_{k}-\overline{x})^{2}}$$

### Incertezza relativa
>[!note]
>L'incertezza relativa è il valore ottenuto quando normalizziamo il valore di incertezza al valore di misura: $$u_{r}(y)= \frac{u(y)}{\overline{y}}$$
